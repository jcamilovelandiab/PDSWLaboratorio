...
public interface ServiciosAlquiler {
   ...
   */
   ...
   public abstract TipoItem consultarTipoItem(int idItem) throws ExcepcionServiciosAlquiler;
   ...
   */
   ...
   public abstract void actualizarTarifaItem(int idItem, long tarifa) throws ExcepcionServiciosAlquiler;

   public abstract void registrarItem(Item it) throws ExcepcionServiciosAlquiler;
